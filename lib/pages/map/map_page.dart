...
class _MapPageState extends State<MapPage> {
  ...
  final List<Map<String, String>> dummyPosts = [
    {'location': '숭례문', 'title': '강남역 러닝 모임', 'startTime': '오늘 오후 6시'},
    {'location': '경복궁', 'title': '부산 조깅 팀', 'startTime': '내일 오전 7시'},
    {'location': '서울역', 'title': '전주 산책 모임', 'startTime': '이번 주말 오후 3시'},
    {'location': '경희궁', 'title': '전주 산책 모임', 'startTime': '이번 주말 오후 3시'},
    {'location': '정부서울청사본관', 'title': '전주 산책 모임', 'startTime': '이번 주말 오후 3시'},
  ];
  ...
  Future<NLatLng?> getCoordsFromKakao(String keyword) async {
    ...
    final response = await http.get(
      url,
      headers: {'Authorization': 'KakaoAK 791070265eff4f73e8343ac2f4dc34dc'},
    );
